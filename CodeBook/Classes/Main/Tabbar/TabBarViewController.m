...
- (void)loadTabbarSubViews {
    ...
    HomeViewController *firstViewController = [[HomeViewController alloc] initWithNibName:@"HomeViewController" bundle:nil];
    UINavigationController *firstNavigationController = [[UINavigationController alloc] initWithRootViewController:firstViewController];
    firstNavigationController.tabBarItem = itemArray[0];
    
    NetworkViewController *secondViewController = [[NetworkViewController alloc]initWithNibName:@"NetworkViewController" bundle:nil];
    UINavigationController *secondNavigationController = [[UINavigationController alloc]initWithRootViewController:secondViewController];
    secondNavigationController.tabBarItem = itemArray[1];
    
    CollectionViewController *thirdViewController = [[CollectionViewController alloc] initWithNibName:@"CollectionViewController" bundle:nil];
