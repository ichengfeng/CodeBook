...
- (void)setJump_bar_code:(NSString *)jump_bar_code {
    
    _jump_bar_code = jump_bar_code;
...
//    [left_Button setTitle:@"back" forState:UIControlStateNormal];
    [left_Button setImage:[UIImage imageNamed:@"btn_back_black"] forState:UIControlStateNormal];
...
//    CGFloat label_Y = CGRectGetMaxY(prompt_message.frame);
    ...
    label.frame = CGRectMake(0, 240, self.view.frame.size.width, 30);
