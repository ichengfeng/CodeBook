...
@implementation XCCategoryTitleImageView
...
- (Class)preferredCellClass {
    return [XCCategoryTitleImageCell class];
}
...
- (void)refreshSelectedCellModel:(JXCategoryBaseCellModel *)selectedCellModel unselectedCellModel:(JXCategoryBaseCellModel *)unselectedCellModel {
    ...
    XCCategoryTitleImageCellModel *myUnselectedCellModel = (XCCategoryTitleImageCellModel *)unselectedCellModel;
    myUnselectedCellModel.imageZoomScale = 1.0;

    XCCategoryTitleImageCellModel *myselectedCellModel = (XCCategoryTitleImageCellModel *)selectedCellModel;
...
- (void)refreshLeftCellModel:(JXCategoryBaseCellModel *)leftCellModel rightCellModel:(JXCategoryBaseCellModel *)rightCellModel ratio:(CGFloat)ratio {
    ...
    XCCategoryTitleImageCellModel *leftModel = (XCCategoryTitleImageCellModel *)leftCellModel;
    XCCategoryTitleImageCellModel *rightModel = (XCCategoryTitleImageCellModel *)rightCellModel;
