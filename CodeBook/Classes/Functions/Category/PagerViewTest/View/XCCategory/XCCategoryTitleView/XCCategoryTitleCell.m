...
@implementation XCCategoryTitleCell
...
- (void)layoutSubviews {
    ...
    XCCategoryTitleCellModel *myCellModel = (XCCategoryTitleCellModel *)self.cellModel;
...
//    XCCategoryTitleCellModel *myCellModel = (XCCategoryTitleCellModel *)cellModel;
