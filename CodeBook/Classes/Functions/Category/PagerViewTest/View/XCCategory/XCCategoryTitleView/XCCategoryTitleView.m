...
#import "XCCategoryTitleView.h"
#import "JXCategoryFactory.h"

@implementation XCCategoryTitleView
...
- (Class)preferredCellClass {
    return [XCCategoryTitleCell class];
}

- (void)refreshDataSource {
    NSMutableArray *tempArray = [NSMutableArray arrayWithCapacity:self.titles.count];
    for (int i = 0; i < self.titles.count; i++) {
        XCCategoryTitleCellModel *cellModel = [[XCCategoryTitleCellModel alloc] init];
...
- (void)refreshSelectedCellModel:(JXCategoryBaseCellModel *)selectedCellModel unselectedCellModel:(JXCategoryBaseCellModel *)unselectedCellModel {
    ...
    XCCategoryTitleCellModel *myUnselectedCellModel = (XCCategoryTitleCellModel *)unselectedCellModel;
    XCCategoryTitleCellModel *myselectedCellModel = (XCCategoryTitleCellModel *)selectedCellModel;
...
- (void)refreshLeftCellModel:(JXCategoryBaseCellModel *)leftCellModel rightCellModel:(JXCategoryBaseCellModel *)rightCellModel ratio:(CGFloat)ratio {
    ...
    XCCategoryTitleCellModel *leftModel = (XCCategoryTitleCellModel *)leftCellModel;
    XCCategoryTitleCellModel *rightModel = (XCCategoryTitleCellModel *)rightCellModel;
...
- (void)refreshCellModel:(JXCategoryBaseCellModel *)cellModel index:(NSInteger)index {
    ...
    XCCategoryTitleCellModel *model = (XCCategoryTitleCellModel *)cellModel;
